    ...
    return (
        <PostContainer>
            <div className="max-w-4xl mx-auto">
                <p className="text-3xl font-bold mb-5">내 프로필</p>
                    ...
                    <div className="p-8">
                        <div className="flex items-center space-x-6">
                            ...
                            <div className="flex-1">
                                <h1 className="text-3xl font-bold ml-2 text-gray-800">{dummyUserInfo.name}</h1>
                                <p className="text-gray-600 ml-2">{dummyUserInfo.role}</p>
                                <div className="flex space-x-4 mt-4 mr-4">
                                    <div className="flex flex-col items-center justify-center cursor-default px-2 py-1">
                                        <p className="font-semibold">{dummyUserInfo.postsCount}</p>
                                        <p className="text-gray-600 text-sm">포스트</p>
                                    </div>
                                    <div
                                        onClick={() => setIsFollowersModalOpen(true)}
                                        className="flex flex-col items-center justify-center cursor-pointer hover:bg-gray-100 px-2 py-1 rounded-xl transition"
                                    >
                                        <p className="font-semibold">{dummyUserInfo.followersCount}</p>
                                    ...
                                    <div
                                        ...
                                        className="flex flex-col items-center justify-center cursor-pointer hover:bg-gray-100 px-2 py-1 rounded-xl transition"
                                    >
                                        <p className="font-semibold">{dummyUserInfo.followingCount}</p>
                        ...
                        <div className="mt-6">
                            ...
                            <p className="text-gray-700">{dummyUserInfo.bio}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="flex space-x-2">
                            <button
                                ...
                                className={`px-4 py-2 rounded-full ${postVisibility === "public" ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-700"}`}
                            >
                                공개 글
                            </button>
                            <button
                                onClick={() => setPostVisibility("private")}
                                className={`px-4 py-2 rounded-full ${postVisibility === "private" ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-700"}`}
                            >
                                비공개 글
                            </button>
                        </div>
